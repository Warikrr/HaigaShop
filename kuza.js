...
�Email Dari Seller 
1 BULAN ADMIN = Rp 4.000
4 BULAN INDIVIDU = Rp 4.000

�Email Dari Buyer 
1 BULAN ADMIN = Rp 3.000
4 BULAN INDIVIDU = Rp 3.000
...
 tidak termasuk fox sport
 region indonesia
 khusus 2 bulan anti back free, durasi langsung 2 bulan tanpa renewal
...
 akun dari mimin
 sistem sharing
 tidak dpt digunakan di ios under 14
 garansi 6 bulan
...
 untuk ios sistem login via apple id
 untuk andro sistem login via email yang diberi
_________________________
PICT ART
...
*FORMAT ORDER KHUSUS WE TV / VIU SHARING*

Nama Aplikasi:
Email cust:

*CONTOH:*
Nama aplikasi: wetv sharing 1 bulan
Email cust: xxxxx@yahoo.com`
  but = [
{ buttonId: `.owner`, buttonText: { displayText: 'Owner' }, type: 1 },
{ buttonId: `.id`, buttonText: { displayText: 'Masukkan Data' }, type: 1 },
{ buttonId: `.payment`, buttonText: { displayText: 'Bayar' }, type: 1 }
...
but = [
          ...
          { buttonId: `${prefix}testi`, buttonText: { displayText: 'TESTI HAGIA SHOP'}, type: 1 }
        ]    
